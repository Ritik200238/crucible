...
function snapshot(): Snapshot {
  return {
    ...
    flow: { hitsBidPerSec: 1.4, liftsAskPerSec: 1.6, windowSec: 20, adverseBuyBps: 0.6, adverseSellBps: 0.5, adverseSamples: 400, volExchangeBps: 1.5, volSettlementBps: 1.8 },
    onchain: null,
    hash: SNAPSHOT_HASH,
  };
}
